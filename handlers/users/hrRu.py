...
def create_hr_Ru(file_path, image_path,data):
    ...
    c.drawString(110,640, f"Tel:  {data[3][:13]}")
    ...
    c.drawString(180,500, "Вопрос")


    c.setFillColorRGB(0, 0, 0)  # kok rang
    c.setFont("DejaVuSerif", 18)
    c.drawString(380,500, "Ответы")
    ...
    savollar = ["Город", "Филиал", "Дата рождения", "Адрес", "Студент", "Зарплата"]
